...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div class="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">…</div> intercepts pointer events
...
- generic [ref=e3]:
  ...
  - generic [ref=e27]:
    ...
    - generic [ref=e50]:
      - generic [ref=e51]:
        - generic [ref=e52]:
          - heading "ARCHIVE" [level=1] [ref=e53]
          - paragraph [ref=e54]: 0 TEXTS // 0 WORDS
        - generic [ref=e55]:
          - button "[ LOAD DEMO ]" [ref=e56] [cursor=pointer]
          - generic [ref=e58] [cursor=pointer]:
            - text: UPLOAD EPUB
            - img [ref=e59]
      - generic [ref=e61]:
        - img [ref=e63]
        - paragraph [ref=e65]: ARCHIVE EMPTY
        - paragraph [ref=e66]: UPLOAD EPUB TO BEGIN INGESTION
  - button "Made by Arphen" [ref=e68] [cursor=pointer]
```
